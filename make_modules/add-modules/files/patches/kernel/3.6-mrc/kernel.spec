...
%{?_with_desktop586: %global build_desktop586 0}
%{?_with_desktop: %global build_desktop 1}
%{?_with_netbook: %global build_netbook 0}
%{?_with_server: %global build_server 0}
%{?_with_doc: %global build_doc 1}
%{?_with_source: %global build_source 0}
%{?_with_devel: %global build_devel 1}
%{?_with_debug: %global build_debug 0}
