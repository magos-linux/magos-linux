#!/bin/bash
NUM=72
NAME=oolite-oxp_pack-planets_povray7
RELEASE=$(date +%Y%m%d)
...
addmod Povray_G7 http://wiki.alioth.net/index.php/PovrayPlanets_OXP "Povray_Planets_Galaxy7_Textures_v1.0_2012-11-06.zip" "Povray_Planets_Galaxy7_Textures.oxp" ""
echo
