#!/bin/bash
NUM=72
NAME=oolite-oxp_pack-planets_povray2
RELEASE=$(date +%Y%m%d)
...
addmod Povray_G2 http://wiki.alioth.net/index.php/PovrayPlanets_OXP "Povray_Planets_Galaxy2_Textures_v1.0_2012_02_11.zip" "Povray_Planets_Galaxy2_Textures_v1.0_2012-02-12/Povray_Planets_Galaxy2_Textures.oxp" ""
echo
