#!/bin/bash
NUM=72
NAME=oolite-oxp_pack-planets_povray4
RELEASE=$(date +%Y%m%d)
...
addmod Povray_G4 http://wiki.alioth.net/index.php/PovrayPlanets_OXP "Povray_Planets_Galaxy4_Textures_v1.0_2012-02-05.zip" "Povray_Planets_Galaxy4_Textures_v1.0_2012-02-05/Povray_Planets_Galaxy4_Textures.oxp" ""
echo
