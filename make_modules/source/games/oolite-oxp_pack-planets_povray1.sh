#!/bin/bash
NUM=72
NAME=oolite-oxp_pack-planets_povray1
RELEASE=$(date +%Y%m%d)
...
addmod Povray_G1 http://wiki.alioth.net/index.php/PovrayPlanets_OXP "Povray_Planets_Galaxy1_Textures_v1.0_2012-02-18.zip" "Povray_Planets_Galaxy1_Textures_v1.0_2012-02-18/Povray_Planets_Galaxy1_Textures.oxp" ""
echo
