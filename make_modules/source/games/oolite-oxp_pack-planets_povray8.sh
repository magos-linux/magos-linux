#!/bin/bash
NUM=72
NAME=oolite-oxp_pack-planets_povray8
RELEASE=$(date +%Y%m%d)
...
addmod Povray_G8 http://wiki.alioth.net/index.php/PovrayPlanets_OXP "Povray_Planets_Galaxy8_Textures_v1.0_2012-11-06.zip" "Povray_Planets_Galaxy8_Textures.oxp" ""
echo
