#!/bin/bash
URL=http://mirror.rosalinux.com/rosa/rosa2012.1/repository/SRPMS/main/updates/systemd-204-22.src.rpm
...
#FIXME to ignore
   ...
   urpmi --buildrequires --auto --test --noclean --no-verify-rpm tmp/source.src.rpm || exit 1
   mkdir builddeps
