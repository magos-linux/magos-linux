#!/bin/bash
URL=http://mirror.rosalinux.com/rosa/rosa2016.1/repository/SRPMS/main/updates/kernel-4.9.20-1.src.rpm
#URL=http://mirror.rosalinux.com/rosa/rosa2016.1/repository/SRPMS/main/release/kernel-4.9.9-1.src.rpm
if ! [ -d builddeps ] ; then
#FIXME to ignore
