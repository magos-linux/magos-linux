...
%ifarch %{ix86}
%define build_desktop686_pae		0
%endif

# Build netbook686 pae (i686 / 64GB)
%ifarch %{ix86}
%define build_netbook686_pae		0
%endif
...
%ifarch %{ix86}
%define build_nrj_desktop686_pae	1
%endif

# Build nrj netbook686 pae (i686 / 64GB)
%ifarch %{ix86}
%define build_nrj_netbook686_pae	1
%endif
...
#
# experimental specific cpu level optimized nrj flavours
#

# Build nrj desktop core2 (i686 / 4GB)
%ifarch %{ix86}
%define build_nrj_desktop_core2   	1
%endif

# Build nrj netbook atom (i686 / 4GB)
%ifarch %{ix86}
...
%{?_without_desktop686_pae: %global build_desktop686_pae 0}
%{?_without_netbook686_pae: %global build_netbook686_pae 0}
...
%{?_without_nrj_desktop686_pae: %global build_nrj_desktop686_pae 0}
%{?_without_nrj_netbook686_pae: %global build_nrj_netbook686_pae 0}
...
%{?_without_nrj_desktop686_pae: %global build_nrj_desktop686_pae 1}
%{?_without_nrj_netbook686_pae: %global build_nrj_netbook686_pae 1}
...
%define build_desktop 0
%define build_netbook 0
%define build_desktop686_pae 1
%define build_netbook686_pae 0
%define build_nrj_desktop586 0
%define build_nrj_desktop 0
%define build_nrj_netbook 0
%define build_nrj_desktop686_pae 0
%define build_nrj_netbook686_pae 0
%define build_server 0
%define build_xen_pvops 0
...
%ifarch %{ix86}
#
# kernel-desktop686-pae: i686, smp-alternatives, 64GB
#
%if %build_desktop686_pae
%define summary_desktop686_pae Linux kernel for desktop use with i686 & upto 64GB RAM
%define info_desktop686_pae This kernel is compiled for desktop use, single or \
multiple i686 processor(s)/core(s) and up to 64GB RAM using PAE, using HZ_1000, \
voluntary preempt, CFS cpu scheduler and cfq i/o scheduler.
%mkflavour desktop686-pae
%endif
%endif

%ifarch %{ix86}
#
# kernel-netbook686-pae: i686, smp-alternatives, 64 GB
#
%if %build_netbook686_pae
%define summary_netbook686_pae Linux Kernel for for netbook use with i686 & upto 64GB RAM
%define info_netbook686_pae This kernel is compiled for netbook use, single or \
multiple i686 processor(s)/core(s) and up to 64GB RAM using PAE, using HZ_1000, \
voluntary preempt, CFS cpu scheduler and cfq i/o scheduler.
%mkflavour netbook686-pae
%endif
%endif
...
%ifarch %{ix86}
#
# kernel-nrj-desktop686-pae: nrj, i686, smp-alternatives, 64GB
#
%if %build_nrj_desktop686_pae
%define summary_nrj_desktop686_pae Linux kernel for desktop use with i686 & upto 64GB RAM
%define info_nrj_desktop686_pae This kernel is compiled for desktop use, single or \
multiple i686 processor(s)/core(s) and up to 64GB RAM using PAE, using HZ_1000, \
full preempt, rcu boost, CFS cpu scheduler and cfq i/o scheduler.
%mkflavour nrj-desktop686-pae
%endif
%endif

%ifarch %{ix86}
#
# kernel-nrj-netbook686-pae: nrj, i686, smp-alternatives, 64 GB
#
%if %build_nrj_netbook686_pae
%define summary_nrj_netbook686_pae Linux Kernel for for netbook use with i686 & upto 64GB RAM
%define info_nrj_netbook686_pae This kernel is compiled for netbook use, single or \
multiple i686 processor(s)/core(s) and up to 64GB RAM using PAE, using HZ_1000, \
full preempt, rcu boost, CFS cpu scheduler and cfq i/o scheduler.
%mkflavour nrj-netbook686-pae
%endif
%endif
...
%ifarch %{ix86}
#
# kernel-nrj-desktop-core2: nrj, intel core2 and up, smp-alternatives, 4GB
#
%if %build_nrj_desktop_core2
%define summary_nrj_desktop_core2 Linux kernel for desktop use with Intel Core2 and newer Intel cpu, less than 4GB RAM
%define info_nrj_desktop_core2 This kernel is compiled for desktop use, single or \
multiple Core2 and newer Intel processor(s)/core(s) and less than 4GB RAM, using HZ_1000, \
full preempt, rcu boost, CFS cpu scheduler and cfq i/o scheduler.
...
%ifarch %{ix86}
#
# kernel-nrj-netbook-atom: nrj, for Atom cpu, smp-alternatives, 4 GB
#
...
for i in /lib/modules/%{kversion}-{desktop586,desktop,netbook,desktop686-pae,netbook686-pae,server,nrj-desktop586,nrj-desktop,nrj-netbook,nrj-desktop686-pae,nrj-netbook686-pae,nrj-desktop-core2,nrj-netbook-atom}-%{buildrpmrel}; do
        if [ -d $i ]; then
...
for i in /lib/modules/%{kversion}-{desktop586,desktop,netbook,desktop686-pae,netbook686-pae,server,nrj-desktop586,nrj-desktop,nrj-netbook,nrj-desktop686-pae,nrj-netbook686-pae,nrj-desktop-core2,nrj-netbook-atom}-%{buildrpmrel}/{build,source}; do
	if [ -L $i ]; then
...
%ifarch %{ix86}
%if %build_desktop686_pae
CreateKernel desktop686-pae
%endif
%endif

%ifarch %{ix86}
%if %build_netbook686_pae
CreateKernel netbook686-pae
%endif
%endif
...
%ifarch %{ix86}
%if %build_nrj_desktop686_pae
CreateKernel nrj-desktop686-pae
%endif
%endif

%ifarch %{ix86}
%if %build_nrj_netbook686_pae
CreateKernel nrj-netbook686-pae
%endif
%endif
...
* Wed Apr 04 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.27-3mib
+ update to 3.0.27
+ UNIONFS stable version 2.5.11
- Kernel 3.0.27 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
+ Starting since release -3, that kernel-desktop is tuned only for 32bit
- MIB "nrj" flavour behaviour with the PAE enabled to support upto 64Gb
- they are more advanced kernels than -1, fine tuned to be more responsive,
- with preempt, rcu boost, for low latency, remote and multimedia Desktops.
- with this release -3, desktop oriented with PAE > -desktop, -netbook
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Wed Apr 04 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.27-2mib
+ update to 3.0.27
+ UNIONFS stable version 2.5.11
- Kernel 3.0.27 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- they are more advanced kernels than -1, fine tuned to be more responsive,
- with preempt, rcu boost, for low latency, remote and multimedia Desktops.
- with this release -2, desktop oriented > -desktop586, -desktop, -netbook
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Wed Apr 04 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.27-1mib
+ update to 3.0.27
+ UNIONFS stable version 2.5.11
- Kernel 3.0.27 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
- with release -1, server oriented > only flavours: -server and -xen-vpops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Sat Mar 24 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.26-2mib
- update to 3.0.26 stable
- Kernel 3.0.26 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- they are more advanced kernels than -1, fine tuned to be more responsive,
- with preempt, rcu boost, for low latency, remote and multimedia Desktops.
- with this release -2, desktop oriented > -desktop586, -desktop, -netbook
...
* Sat Mar 24 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.26-1mib
- update to 3.0.26 stable
- Kernel 3.0.26 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
- with release -1, server oriented > only flavours: -server and -xen-vpops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Thu Mar 22 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.26-rc1-2mib
- update to 3.0.26 rc1
- Kernel 3.0.26 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- these are more advanced kernels than -1, fine tuned to be more responsive,
- with preempt, rcu boost, for low latency, remote and multimedia Desktops.
- with this release -2, desktop oriented > -desktop586, -desktop, -netbook
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Thu Mar 22 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.26-rc1-1mib
- update to 3.0.26 rc1
- Kernel 3.0.26 adapted for mdv 2010.2, 2011.0, cooker, and rosa.lts2012.0
- with release -1, server oriented > only flavours: -server and -xen-vpops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Mon Mar 19 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.25-2mib
- update to 3.0.25
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- these are more advanced kernels than -1, fine tuned to be more responsive,
- with preempt, rcu boost, for low latency, remote and multimedia Desktops.
...
* Mon Mar 19 2012 Nicolo' Costanza <abitrules@yahoo.it> 3.0.25-1mib
- update to 3.0.25
- Kernel 3.0.25 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Wed Dec 21 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.14-2mib
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- with preempt, rcu boost, for low latency, remote and multimedia Desktops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Wed Dec 21 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.14-1mib
- update to 3.0.14
- Kernel 3.0.14 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Fri Dec 09 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.13-2mib
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- with preempt, rcu boost, for low latency, remote and multimedia Desktops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Fri Dec 09 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.13-1mib
- update to 3.0.13
- Kernel 3.0.13 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Sat Dec 03 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.12-2mib
+ Starting since release -2 is updated to MIB "nrj" flavour behaviour:
- with preempt, rcu boost, for low latency, remote and multimedia Desktops
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Tue Nov 29 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.12-1mib
- Kernel 3.0.12 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Mon Nov 28 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.11-1mib
- Kernel 3.0.11 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Fri Nov 25 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.10-1mib
- Kernel 3.0.10 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/

* Thu Oct 20 2011 Nicolo' Costanza <abitrules@yahoo.it> 3.0.7-1mib
- Kernel 3.0.7 backport adapted for mdv 2010.2, 2011.0, cooker
- MIB (Mandriva International Backports) - http://mib.pianetalinux.org/
