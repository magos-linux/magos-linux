...
# %define kconflicts1	dkms-broadcom-wl < 5.100.82.112-x
# %define kconflicts2	dkms-fglrx < 9.010.8-x
# %define kconflicts3	dkms-nvidia-current < 310.19-x
# %define kconflicts4	dkms-nvidia304 < 304.64-x
# %define kconflicts5	dkms-nvidia173 < 173.14.36-x
