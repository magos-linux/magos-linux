...
boot\tools\WIN\mkisofs.exe @boot\grub4dos\iso_conf -o "%ISOPATH%\%CDLABEL%.iso" -A "%CDLABEL%" -V "%CDLABEL%" -m '*_save*' MagOS=MagOS boot=boot EFI=EFI magos.ldr=boot\grub4dos\magos.ldr
echo.
