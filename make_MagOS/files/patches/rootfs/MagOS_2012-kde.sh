...
sed -i 's|^prefixes=.*|prefixes=/var/lib/mandriva/kde4-profiles/common,/var/lib/mandriva/kde4-profiles/Default,/usr/share/magos/kde4|' var/lib/mandriva/kde4-profiles/Default/kde4-config
exit 0
