    ...
    RowLayout {
        ...
        BreezeLabel {
            ...
            text: {
                ...
                switch(state) {
                case "Charging":
                    return i18nd("plasma_lookandfeel_rosa.fresh.lookandfeel","%1%. Charging", battery.percent)
                case "FullyCharged":
                    return i18nd("plasma_lookandfeel_rosa.fresh.lookandfeel","Fully charged")
                case "NoCharge":
                    return i18nd("plasma_lookandfeel_rosa.fresh.lookandfeel","%1%. Plugged in, not charging", battery.percent)
                default:
                    return i18nd("plasma_lookandfeel_rosa.fresh.lookandfeel","%1% battery remaining", battery.percent)
                }
            }
            Layout.alignment: Qt.AlignRight
            wrapMode: Text.Wrap
