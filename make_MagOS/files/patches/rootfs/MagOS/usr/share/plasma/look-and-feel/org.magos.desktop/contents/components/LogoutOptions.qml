...
PlasmaComponents.ButtonRow {
    ...
    PlasmaComponents.ToolButton {
        ...
        checkable: true
        Accessible.name: i18ndc("plasma_lookandfeel_rosa.fresh.lookandfeel", "Button to restart the computer", "Reboot")
    ...
    PlasmaComponents.ToolButton {
        ...
        checkable: true
        Accessible.name: i18ndc("plasma_lookandfeel_rosa.fresh.lookandfeel", "Button to shut down the computer", "Shut down")
        activeFocusOnTab: true
    ...
    PlasmaComponents.ToolButton {
        ...
        checkable: true
        Accessible.name: i18ndc("plasma_lookandfeel_rosa.fresh.lookandfeel", "Button to log out of the desktop session", "Log out")
        activeFocusOnTab: true
