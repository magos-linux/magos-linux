...
for plugin in plugins:
	gettext.install(plugin['i18n'], localedir='./locale', codeset=None, names=None)
	#gettext.install( plugin['i18n'], './locale', 'str=True')
	print('<h2><a href="#head1"> %s </a></h2>' % _(plugin['name'])) 
	print('<div id="head1" onclick=\'select("%s")\'><p>%s</p></div>' % (plugin['url'], _(plugin['action_name']))) 
