...
diff -aupr a/org.mate.screensaver.gschema.xml b/org.mate.screensaver.gschema.xml
--- a/org.mate.screensaver.gschema.xml	2021-09-02 00:05:52.000000000 +0300
+++ b/org.mate.screensaver.gschema.xml	2021-11-16 10:40:58.000000000 +0300
@@ -6,22 +6,22 @@
   </enum>
...
diff -aupr a/org.mate.panel.menubar.gschema.xml b/org.mate.panel.menubar.gschema.xml
--- a/org.mate.panel.menubar.gschema.xml	2021-09-29 08:17:14.000000000 +0300
+++ b/org.mate.panel.menubar.gschema.xml	2021-11-16 20:38:04.918032212 +0300
@@ -31,7 +31,7 @@
       <description>If true, show icon in menu bar.</description>
     </key>
     <key name="icon-name" type="s">
-      <default>'start-here'</default>
+      <default>'magos'</default>
