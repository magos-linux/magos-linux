...
update_app modem-manager-gui "Telephony;HardwareSettings;Qt;KDE;Network;"
update_app net_applet "GTK;Network;Monitor;Settings;X-GNOME-NetworkSettings;"
...
update_app draw "Office;Editor;"
update_app base "Office;Editor;"
update_app web "Office;Editor;"
update_app dia "Office;Editor;"
update_app libreoffice-base "Office;Editor;;"
update_app libreoffice-calc "Office;Editor;"
update_app libreoffice-draw "Office;Editor;"
update_app libreoffice-impress "Office;Editor;"
update_app libreoffice-math "Office;Editor;"
update_app libreoffice-startcenter "Office;Editor;"
update_app libreoffice-writer "Office;Editor;"
update_app java-1.6.0-sun-controlpanel "Settings;"
update_app java-1.6.0-sun-javaws "Settings;"
update_app java-1.6.0-sun-javaws_viewer "Settings;"
update_app java-1.6.0-sun-policytool "Settings;"
update_app gparted "GTK;System;Filesystem;Settings;HardwareSettings;X-MandrivaLinux-System-Configuration;"
update_app rawtherapee "GTK;Graphics;2DGraphics;RasterGraphics;"
update_app nautilus-browser "GNOME;GTK;System;Utility;Core;FileManager;"
update_app PlayOnLinux "Emulator;"
update_app easytag "AudioVideo;Audio;AudioVideoEditing;GTK;"
...
update_app add2sudoers "Settings;System;"
update_app rmfromsudoers "Settings;System;"
...
update_app drakxservices "Settings;System;"
...
update_app mandriva-usermount "System;Filesystem;Settings;HardwareSettings;Utility;"
update_app protontricks "Game;"
...
update_app kde5/org.kde.kate "Qt;KDE;Utility;TextEditor;"
update_app org.kde.kate "Qt;KDE;Utility;TextEditor;"
...
update_app yad-icon-browser "Utility;FileTools;"
...
HIDEPROGS="$HIDEPROGS fusion-icon emerald-theme-manager kde5/kshutdown rofi-theme-selector rofi"
...
#BUGFIX remove zero files
for a in /usr/share/applications/*.desktop ;do 
  grep -q . "$a" || rm -f "$a"
done
