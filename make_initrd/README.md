...
7. Осуществляется синхронизация base-уровня в cache-уровень с учетом параметра uird.copy2cache=, а также соответсвия подуровней
...
!!!(не реализовано, пока используется только конфиг внутри initrd) Если параметр uird.basecfg= не задан, то используется /basecfg.ini внутри initrd.
